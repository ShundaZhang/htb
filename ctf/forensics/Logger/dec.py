#tshark -r keystrokes.pcapng -Y 'usb' -V |grep Leftover > keys.txt
...
maps = {value:key for key, value in map0.items()}

keys = [0x39,0x0b,0x17,0x05,0x39,0x0c,0x39,0x06,0x21,0x11,0x22,0x20,0x20,0x39,0x1c,0x39,0x12,0x18,0x39,0x15,0x39,0x0e,0x20,0x1c,0x1f,0x39]

for key in keys:
	print maps[key],

#CAPSLOCK H T B CAPSLOCK I CAPSLOCK C 4 N 5 3 3 CAPSLOCK Y CAPSLOCK O U CAPSLOCK R CAPSLOCK K 3 Y 2 CAPSLOCK
